...
#define LORAWAN_DEVICE_EUI                                                                         \
    { 0x00, 0x80, 0xE1, 0x01, 0x01, 0x01, 0x01, 0x01 }
...
#define LORAWAN_APP_KEY 5f, f2, 8c, 28, e1, 65, 8f, 34, 26, d5, af, 9b, a5, 4b, 80, 4b

/*!
 * Network root key
 */
//#define LORAWAN_NWK_KEY 2B, 7E, 15, 16, 28, AE, D2, A6, AB, F7, 15, 88, 09, CF, 4F, 3C
#define LORAWAN_NWK_KEY 5f, f2, 8c, 28, e1, 65, 8f, 34, 26, d5, af, 9b, a5, 4b, 80, 4b
...
#define RAW_TO_INT8A(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p)                               \
    {                                                                                              \
        0x##a, 0x##b, 0x##c, 0x##d, 0x##e, 0x##f, 0x##g, 0x##h, 0x##i, 0x##j, 0x##k, 0x##l, 0x##m, \
            0x##n, 0x##o, 0x##p                                                                    \
    }
...
#define SESSION_KEYS_LIST                                                                          \
    {                                                                                              \
         ...
         */                                                                                        \
        .KeyID = J_S_INT_KEY,                                                                      \
        .KeyValue = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
                     0x00, 0x00, 0x00},                                                            \
    },                                                                                             \
        {                                                                                          \
            /*! \                                                                                                 \
             ...
             */                                                                                    \
            .KeyID = J_S_ENC_KEY,                                                                  \
            .KeyValue = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,   \
                         0x00, 0x00, 0x00, 0x00},                                                  \
        },                                                                                         \
        {                                                                                          \
            /*! \                                                                                                 \
        ...
        {                                                                                          \
            ...
            .KeyValue = {0x2B, 0x7E, 0x15, 0x16, 0x28, 0xAE, 0xD2, 0xA6, 0xAB, 0xF7, 0x15, 0x88,   \
                         0x09, 0xCF, 0x4F, 0x3C},                                                  \
        },                                                                                         \
        {                                                                                          \
            /*! \                                                                                                 \
    ...
    {                                                                                              \
        {                                                                                          \
            ...
            SESSION_KEYS_LIST{                                                                     \
                 ...
                 */                                                                                \
                .KeyID = MC_ROOT_KEY,                                                              \
                .KeyValue = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,     \
